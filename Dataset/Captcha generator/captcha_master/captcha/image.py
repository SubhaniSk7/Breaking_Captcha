...
class ImageCaptcha(_Captcha):
    ...
    """
    def __init__(self, width=160, height=60, fonts=None, font_sizes=None, noise_point = 30):
        self._width = width
        self._height = height
        self._fonts = fonts or DEFAULT_FONTS
        self._font_sizes = font_sizes or (42, 50, 56)
        self._truefonts = []
        self._noise_points = noise_point
    ...
    def generate_image(self, chars):
        ...
        self.create_noise_dots(im, color,width=3, number=self._noise_points)
